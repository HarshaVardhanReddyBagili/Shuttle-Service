...
if uploaded_file is not None:     
    ...
    g = nx.from_pandas_edgelist(data, 'Origin', 'Destination', edge_attr=['Distance_meters','Duration_min_minutes']) #Use the Graph API to create an empty network graph object
